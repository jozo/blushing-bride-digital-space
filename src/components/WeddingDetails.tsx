...
const WeddingDetails = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-cream-50 to-cream-100" id="details">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif text-cream-800 mb-4">Wedding Details</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-serif text-cream-800 mb-4">Ceremony</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-serif text-cream-800 mb-4">Reception</h3>
              <div className="space-y-3 text-cream-700">
                <div className="flex items-center justify-center space-x-2">
                  <Clock className="h-4 w-4" />
                  <span>6:00 PM</span>
