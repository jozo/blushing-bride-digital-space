...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 to-pink-100 relative overflow-hidden">
      ...
      <div className="text-center z-10 px-4">
        <div className="animate-fade-in">
          <Heart className="mx-auto mb-6 text-rose-400 h-12 w-12 animate-pulse" />
          ...
          <button className="bg-rose-400 hover:bg-rose-500 text-white px-8 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105 shadow-lg">
            View Our Story
          </button>
        </div>
      </div>
